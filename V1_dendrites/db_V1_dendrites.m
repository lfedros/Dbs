...
db(i).morph.zoom = 2.1;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 115; 
db(i).morph.apicalNode    = [113 185];        
db(i).morph.upSamp    = 1;  
db(i).morph.dendrotomy    = {1, 'para'};
...
db(i).morph.zoom = 1.2;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 255; 
db(i).morph.apicalNode    = [42];        
db(i).morph.upSamp    = 2; 
db(i).morph.dendrotomy    = {1, 'para'};
db(i).retino.expRef  = {'FR171', '2020-09-23', 1};   
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 1.2;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 148; 
db(i).morph.apicalNode    = [140];        
db(i).morph.upSamp    = 2; 
db(i).morph.dendrotomy    = {1, 'para'};
db(i).retino.expRef  = {'FR171', '2020-09-23', 1};   
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 305;  
db(i).morph.apicalNode    = [353];        
db(i).morph.upSamp    = 2; 
db(i).morph.dendrotomy    = {1, 'para'};
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 228;
db(i).morph.apicalNode    = [447];        
db(i).morph.upSamp    = 2; 
db(i).morph.dendrotomy    = {0, []};
db(i).retino.expRef  = {'FR172', '2020-10-30', 1}; 
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 243; 
db(i).morph.apicalNode    = [273];        
db(i).morph.upSamp    = 2;    
db(i).morph.dendrotomy    = {1, 'para'};
db(i).retino.expRef  = {'FR172', '2020-10-30', 1};    
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 300; 
db(i).morph.apicalNode    = [440];        
db(i).morph.upSamp    = 2;   
db(i).morph.dendrotomy    = {1, 'para'};
db(i).retino.expRef  = {'FR172', '2020-10-30', 1};
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 1.5;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 101; 
db(i).morph.apicalNode    = [2 801];        
db(i).morph.upSamp    = 2; 
db(i).morph.dendrotomy    = {1, 'para'};
...
db(i).morph.zoom = 1.5;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 131 ;
db(i).morph.apicalNode    = [505];        
db(i).morph.upSamp    = 2; 
db(i).morph.dendrotomy    = {1, 'orth'};
db(i).retino.expRef  = {'FR175', '2020-12-07', 4};  
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 2.1;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 178;   
db(i).morph.apicalNode    = [548];        
db(i).morph.upSamp    = 1;
db(i).morph.dendrotomy    = {1, 'orth'};
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 208;    
db(i).morph.apicalNode    = [476];        
db(i).morph.upSamp    = 1;
db(i).morph.dendrotomy    = {1, 'orth'};
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 199; 
db(i).morph.apicalNode    = [404];        
db(i).morph.upSamp    = 2;
db(i).morph.dendrotomy    = {1, 'para'};
...
db(i).morph.zoom = 1.6;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 258;    
db(i).morph.apicalNode    = [532];        
db(i).morph.upSamp    = 2;
db(i).morph.dendrotomy    = {1, 'orth'};
db(i).retino.expRef  = {'FR187', '2021-03-25', 11};   
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 1.3;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 210;    
db(i).morph.apicalNode    = [832];        
db(i).morph.upSamp    = 2;
db(i).morph.dendrotomy    = {1, 'para'};
...
db(i).morph.zoom = 1.3;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 241;   
db(i).morph.apicalNode    = [966];        
db(i).morph.upSamp    = 2;
db(i).morph.dendrotomy    = {1, 'orth'};
db(i).retino.expRef  = {'FR184', '2021-03-25', 6};   
db(i).retino.expID   = 1;           
...
db(i).morph.zoom = 2.1;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 205;  
db(i).morph.apicalNode    = [286 2];        
db(i).morph.upSamp    = 1;
db(i).morph.dendrotomy    = {1, 'orth'};
...
% db(i).neuron_id = 22;
% db(i).data_repo = data_repo;
% db(i).morph.expRef = {'FR184', '2021-03-26', 4}; % check functional refs
% db(i).morph.tilt = [0,0]; % (rc, ml)
% db(i).morph.zoom = 1.8;
% db(i).morph.zStep = 1;
% db(i).morph.somaZ    = 180;    
% db(i).morph.apicalNode    = [518];        
% db(i).morph.upSamp    = 1;
% db(i).morph.dendrotomy    = {1, 'para'};
...
db(i).morph.zoom = 1.8;
db(i).morph.zStep = 1;
db(i).morph.somaZ    = 235;    
db(i).morph.apicalNode    = [606];        
db(i).morph.upSamp    = 1;
db(i).morph.dendrotomy    = {1, 'para'};
db(i).retino.expRef  = {'FR184', '2021-03-26', 5};   
db(i).retino.expID   = 1;           
